function	[dip,xl,xu, ifault, gcm, lcm, mn, mj] = HartigansDipTest(xpdf, varargin)
...
% 
% downloaded from http://www.nicprice.net/diptest on 7/28/2016
% Tom Pearce edited code to fix matlab warnings
...
%    if (x ~= sort(x)) %x was sorted already...
%       ifault=3;
%       fprintf(1,'\nHartigansDipTest.    InputError :  ifault=%d\n',ifault);
%       return;
%    end;
